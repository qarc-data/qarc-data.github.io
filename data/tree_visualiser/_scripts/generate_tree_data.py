...
def load_and_build_forest(file, verbose=True):
...
def generate_visualisation(file, tree_data_dir='../tree_data', verbose=True):
    forest = load_and_build_forest(file=file, verbose=verbose)
    # Tree visualiser
    list_keys = []
...
def main(file, verbose=True):
    generate_visualisation(file=file, verbose=verbose)


if __name__ == '__main__':
    main(file='../../quarc1-train.json')
